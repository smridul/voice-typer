...
- Mac app built from main (keyboard-layout fix + Start/Stop Recording menu item + status item autosave name + floating record button with right-click menu), pynput 1.8.2, installed to /Applications, running under launchd. Needs Accessibility / Input Monitoring re-granted after each rebuild.
