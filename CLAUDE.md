...
- Mac app built from main (keyboard-layout fix c082419 + Start/Stop Recording menu item + status item autosave name), pynput 1.8.2, installed to /Applications, running under launchd. Needs Accessibility / Input Monitoring re-granted after each rebuild.
- Menu bar icon currently invisible because of the macOS 26.6 Control Center bug above; hotkey works. User has not yet rebooted.
